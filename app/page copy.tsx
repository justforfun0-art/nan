          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center justify-between px-6 py-4 rounded-2xl bg-black/60 backdrop-blur-xl border border-white/10">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 via-pink-500 to-orange-400 flex items-center justify-center font-black text-lg shadow-lg">
                  N
                </div>
                <span className="text-lg font-bold hidden sm:block">
                  <span className="text-white">nano</span>
                  <span className="text-violet-400">fluencers</span>
                </span>
              </div>
              <div className="flex items-center gap-3">
                <a href="#features" className="hidden md:block px-4 py-2 text-sm text-white/60 hover:text-white transition-colors">
                  Features
                </a>
                <a href="#platforms" className="hidden md:block px-4 py-2 text-sm text-white/60 hover:text-white transition-colors">
                  Platforms
                </a>
                <a href="/admin" className="px-5 py-2.5 text-sm font-medium rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 transition-all">
                  Admin
                </a>
              </div>
            </div>
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-white font-semibold">10,000+</span> nano-influencers already earning.
            </motion.p>
        ...
        <section className="py-24 md:py-32 px-6">
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
              {[
                { value: '10000', suffix: '+', label: 'Influencers', color: 'violet' },
                { value: '500', suffix: '+', label: 'Brands', color: 'pink' },
                { value: '50', suffix: 'L+', label: 'Earned (₹)', color: 'emerald' },
            ...
            <div className="grid md:grid-cols-4 gap-12 mb-16">
              <div className="md:col-span-2">
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 via-pink-500 to-orange-400 flex items-center justify-center font-black">
                    N
                  </div>
